...
def parse_args():
    ...
    # Data directories (local default paths)
    parser.add_argument("--train-dir", type=str, default="data/training")
...
def main():
    ...
    print(f"Train CSV: {os.path.join(args.train_dir, 'train_sent_emo.csv')}")
    print(f"Train Videos: {os.path.join(args.train_dir, 'train_splits')}")
